...
const CACHE_NAME = 'yiyinails-v49';
const urlsToCache = [
  '/yiyinails/',
  '/yiyinails/index.html',
  '/yiyinails/admin.html',
  '/yiyinails/admin-login.html',
  '/yiyinails/calendar.html',
  '/yiyinails/setup-wizard.html',
  '/yiyinails/editar-negocio.html',
  '/yiyinails/manifest.json',
  '/yiyinails/icons/icon-72x72.png',
  '/yiyinails/icons/icon-96x96.png',
  '/yiyinails/icons/icon-128x128.png',
  '/yiyinails/icons/icon-144x144.png',
  ...
  '/yiyinails/utils/push-config.js',
  '/yiyinails/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/yiyinails/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/yiyinails/icons/icon-192x192.png',
    badge: '/yiyinails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/yiyinails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/yiyinails/admin.html';
  event.waitUntil(
...
console.log('✅ Service Worker configurado para Yiyi nails');
